...
All reference files are found in vendor/erpnext...
...
- Accounts – financial accounting, ledgers and payment entries.
- CRM – lead and opportunity management with onboarding helpers.
- Buying – purchase orders, supplier quotes and RFQs.
- Projects – project planning, tasks and timesheets.
- Selling – quotations, sales orders and Point of Sale.
- Setup – installation wizard and default company settings.
- Manufacturing – BOMs, work orders and production plans.
- Stock – inventory ledger, valuation and item utilities.
- Support – issue tracking and SLA monitoring.
- Utilities – generic tools like naming series and SMS logs.
- Assets – asset acquisition, depreciation and disposals.
- Portal – website portal home pages and user records.
- Maintenance – equipment and asset maintenance schedules.
- Regional – country-specific templates and VAT reports.
- ERPNext Integrations – connectors such as Plaid.
- Quality Management – non-conformance and reviews.
- Communication – communication mediums and time slots.
- Telephony – call logs and incoming call popups.
- Bulk Transaction – background bulk processing.
- Subcontracting – outsourced manufacturing workflows.
- EDI – electronic data interchange code lists and importers.

## Other Topics

- Core – repository settings, hooks and shared code.
- Controllers – server and client controllers used across modules.
- Domains – domain activation to tailor features by industry.
- Patches & Change Log – database migrations and release notes.
- Web & Templates – website assets, templates and portal pages.
- Translations – localization files and translation hooks.
- Tests – Python and JavaScript test suites.
- GitHub / CI – contribution guidelines and CI workflows.
